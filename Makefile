...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=iq-chain \
		  -X github.com/cosmos/cosmos-sdk/version.AppName=iq-chaind \
...
install: go.sum
	go install -mod=readonly $(BUILD_FLAGS) ./cmd/iq-chaind

build:
	go build $(BUILD_FLAGS) -o ./build/iq-chaind ./cmd/iq-chaind
