...
import DecipherhubIqChainDecipherhubIqchainIqchain from './decipherhub/iq-chain/decipherhub.iqchain.iqchain'
...
export default { 
  ...
  DecipherhubIqChainDecipherhubIqchainIqchain: load(DecipherhubIqChainDecipherhubIqchainIqchain, 'decipherhub.iqchain.iqchain'),
